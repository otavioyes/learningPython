...
choice1 = input('You are at a crossroads, deciding which way to go "left" or "right":  ').lower()

if choice1 == "left":
    choice2 = input('You\'re a lost in the forest, do you "make a fire" '
                    'or "keep walking"?: ').lower()

    if choice2 == "make a fire":
        choice3 = input('Good choice, it is morning and the beasts have gone to rest,'
        'do you "build a hut" or look for a "river"?: ').lower()
        ...
        if choice3 == "river":
            choice4 = input('You\'re almost there! You\'ve found a cave with bats and a\n '
                            ...
                            'in the "cave" or inside the "waterfall"?: ').lower()
            if choice4 == "cave":
